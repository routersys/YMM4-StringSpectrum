...
internal static class StringSpectrumUpdateNotifier
{
    private const string Owner = "routersys";
    private const string Repository = "YMM4-StringSpectrum";
    ...
    private static async Task RunAsync()
    {
        try
        {
            ...
            {
                CurrentVersion = PluginVersion.FromAssemblyInformationalVersion(typeof(StringSpectrumUpdateNotifier)),
    ...
    private static Task ShowNotificationAsync(UpdateNotification notification, CancellationToken cancellationToken)
    {
        ...
        return application.Dispatcher.InvokeAsync(() =>
            MessageBox.Show(notification.Message, Texts.StringSpectrum, MessageBoxButton.OK, MessageBoxImage.Information)).Task;
    }
}
